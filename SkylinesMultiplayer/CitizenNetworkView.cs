...
{
    class CitizenNetworkView : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //If you haven't got a new state in a while then remove the citizen
            if (NetTime.Now - m_bufferedState[0].timestamp > m_despawnLimit)
            {
                MultiplayerManager.instance.m_cNetworkManager.RemoveCitizen(m_id);
            }
