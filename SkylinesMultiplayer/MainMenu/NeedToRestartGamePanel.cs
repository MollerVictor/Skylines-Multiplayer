...
{
    class NeedToRestartGamePanel : UIPanel
    {
        private const string HELP_STRING = "You need to restart the game to get the game back to normal.";
        ...
        public override void Start()
        {
            ...
            connectButton.eventClick += OnClickExit;
